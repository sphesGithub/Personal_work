       ...
       if(!isPasswordsMatch($password,$confirm_password)){
        ...
        if($nameErr == "" && $surnameErr == "" && $emailErr == "" &&  $passwordErr == "<ul></ul>" && $confirm_passwordErr == "" && $birthdayErr == ""){
            ...
            if ($email_check_result->num_rows > 0) {
                ...
                $new_user_query = "INSERT INTO USER (name, surname, gender, birthday, email, password, role)
                                    VALUES ('$name', '$surname', '$gender', '$birthday', '$email', '$hashed_password', 'admin')";
...
<body>
    ...
    <?php $page_title="New Admin"; include("components/header.php") ?>

    <div class="form-container custom-form_signup">
        <div id="div-form" class="slide-in">

            <form name="signup_form" id="signup_form" action="new_admin.php" method="POST" novalidate>
